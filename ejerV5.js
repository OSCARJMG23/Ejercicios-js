...
var dni = parseFloat(prompt('Ingrese el numero de su DNI: '))

do{ 
    document.write(`El DNI es ${dni} y la letra que le corresponde es ${letra}` +'<br>')
    if(dni >0 && dni <=99999999){
        ...
        document.write('Ingrese un numero de DNI valido')
    }
    dni = parseFloat(prompt('Ingrese otro numero de DNI o "000" para detener: '))
}while(dni != 000) */
